...
lyr_CambodiaLaosThailandVietnamMalaysiaMyanmarbilingual_0.setVisible(true);lyr_pl_amphoe_1.setVisible(true);lyr_pl_tambon_2.setVisible(true);lyr_pl_stream_3.setVisible(true);lyr_pl_transportation_4.setVisible(true);lyr_pl_village_5.setVisible(true);
var layersList = [lyr_CambodiaLaosThailandVietnamMalaysiaMyanmarbilingual_0,lyr_pl_amphoe_1,lyr_pl_tambon_2,lyr_pl_stream_3,lyr_pl_transportation_4,lyr_pl_village_5];
...
lyr_pl_stream_3.set('fieldImages', {'LENGTH': '', 'STR_ID': '', 'STR_NAM_T': '', 'STR_NAM_E': '', 'LOCAL_NAM': '', 'STR_TYPE': '', });
